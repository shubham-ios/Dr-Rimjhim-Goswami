    ...
    <>
      ...
      <Layout>
            ...
            <div className="order-2 lg:order-1 relative z-10">
               ...
               <div className="mb-6 grid grid-cols-1 grid-rows-1">
                {headlines.map((text, idx) => (
                  <h1 
                    key={idx}
                    className={`col-start-1 row-start-1 font-serif text-4xl md:text-5xl lg:text-6xl font-medium leading-tight text-sage transition-opacity duration-1000 ${
        ...
        <section className="h-[400px] w-full bg-gray-200 relative">
          <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3506.119131666465!2d77.1751!3d28.5061!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce1e1e1e1e1e1%3A0x1e1e1e1e1e1e1e1e!2sChhatarpur%2C%20New%20Delhi!5e0!3m2!1sen!2sin!4v1697555555555!5m2!1sen!2sin" 
            width="100%" 
            height="100%" 
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-6 rounded-xl shadow-xl max-w-xs text-center">
              ...
              <p className="text-charcoal/70 text-sm mb-4">Open Mon-Sat, 10am - 7pm</p>
              <Link to="/contact" className="text-rose text-sm font-bold uppercase tracking-wider">Get Directions</Link>
          </div>
        </section>
      </Layout>
    </>
